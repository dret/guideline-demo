# Axway API Guideline Generator

- [API Style](why/api-style/ "APIs should be using the API style that best matches their service and consumers")
...
- [Documenting API Motivation](why/api-motivation/ "Why does the API exist?")
